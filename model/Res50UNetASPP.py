...
def Res50UNetASPP(n_channel=1, n_classes=1, weights= None, progress: bool = True, **kwargs: Any) -> ResNet:
    return _resnet(Bottleneck, [3, 4, 6, 3], weights, progress, **kwargs)
...
if __name__ == "__main__":
    model = Res50UNetASPP(n_channel=1, n_classes=3).cuda()
