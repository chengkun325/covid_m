...
class ResSwinUNetMsECA5(nn.Module):
    def __init__(self, n_channel, n_classes=3):
        super(ResSwinUNetMsECA5, self).__init__()
...
if __name__ == "__main__":
    ...
    model = ResSwinUNetMsECA5(1, 1).cuda()
    y = model(img)
    print(y.size())
