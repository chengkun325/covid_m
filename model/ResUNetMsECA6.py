...
class DoubleConv(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv = nn.Sequential(
            ...
            ResBlock(out_channel, out_channel, out_channel)
        )
...
class ResUNetMsECA6(nn.Module):
    def __init__(self, n_channel, n_classes=3):
        super(ResUNetMsECA6, self).__init__()
...
if __name__ == "__main__":
    ...
    print(summary(ResUNetMsECA6(1, 1).to(device), input_size=(1, 256, 256), batch_size=-1))
