...
class DESegNet4(nn.Module):
    def __init__(self, n_channel, n_classes=3):
        super(DESegNet4, self).__init__()
        ...
        self.conv1 = nn.Conv2d(384, 512, 1)
        self.conv2 = nn.Conv2d(192, 512, 1)
        self.conv3 = nn.Conv2d(96, 256, 1)
