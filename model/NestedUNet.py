...
class NestedUNet(nn.Module):
    def __init__(self, n_channel, n_classes=3, deep_supervision=False, **kwargs):
        super().__init__()
        ...
        self.conv0_0 = VGGBlock(n_channel, nb_filter[0], nb_filter[0])
...
if __name__ == '__main__':
    ...
    # print(summary(NestedUNet(1,1).to(device), input_size=(1, 224, 224), batch_size=-1))
