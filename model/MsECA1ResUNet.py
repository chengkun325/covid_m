...
class MsECA1ResUNet(nn.Module):
    def __init__(self, n_channel, n_classes=3):
        super(MsECA1ResUNet, self).__init__()
...
if __name__ == "__main__":
    ...
    print(summary(MsECA1ResUNet(4, 1).to(device), input_size=(4, 224, 224), batch_size=-1))
